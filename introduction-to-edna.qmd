...
This typically involves DNA from "visible" organisms.
This distinction helps clarify that eDNA studies are often associated with microbial DNA from soil or water, which also originates from living organisms.
...
This preserved DNA is referred to as ancient eDNA.
...
Consequently, the earliest studies in this field have emerged recently in the early 2000s, less than two decades ago [@Coolen1998-qi] (Willerslev et al., 2003).
...
This reservation is facilitated by oxygen-depleted and cold sediments in aquatic environments, as well as the sheltered conditions provided by caves, which can offer relatively stable temperature and humidity [@Capo2023-og].
These preservation conditions allows for significant potential in reconstructing past environments and tracking ecological changes over time (Kjær et al., 2022).

## What can we find in sedimentary DNA records?

Sediments consist of inorganic and organic matter, including eDNA, that accumulate over time, creating temporally resolved archives.
The vertical stratigraphy of these sediments allows for the reconstruction of temporal transects through the sediment core (ref).
In aquatic environments, the sedimentary DNA record comprises a mixture of genetic materials from organisms that lived within the lake (autochthonous material) and those from the surrounding area and its catchment (allochthonous material) (Capo et al., 2022).
Caves can act as natural traps where organisms repeatedly fall in and perish, or as places of refuge where organisms seek shelter (Murchie et al., 2023).
Consequently, the sedimentary records in caves include genetic material from these organisms.
...
The pool of DNA preserved within sediments can be categorised into two primary fractions (@fig-introductiontoedna-figure3):
...
![Composition of the DNA pool preserved in aquatic sediments. Modified from Capo et al., 2022.](assets/images/chapters/introduction-to-edna/figure3.jpg){#fig-introductiontoedna-figure3}

## Taphonomic processes of sedimentary DNA

The reliability of DNA records is influenced by taphonomic processes.
...
In this section, we will focus on aquatic environments (@fig-introductiontoedna-figure4), but similar processes also affect sediment records in caves.

### Origin of eDNA in sediments

Several factors come into play in determining how DNA is incorporated and buried within the sediments.
These factors include organism abundance, spatial distribution, cyst-forming ability, and the edibility of the focal taxon.
For terrestrial organisms residing in the surrounding area of aquatic environment, it is crucial to account for material transport and the transfer of DNA from the source environment.
This transfer is likely influenced by numerous factors such as soil erosion and hydrological connectivity.
...
- **Long-term preservation in the environment**: Despite the occurrence of the previous processes, extracellular DNA can still persist in the environment.
    Optimal DNA preservation conditions in aquatic environments include systems with cooler temperatures, lakes with minimal bioturbation, anoxic conditions at the sediment-water interface, and freshwater and neutral to slightly alkaline lakes (Jia et al., 2022).
    DNA can be protected from nucleases by binding to humic acids due to a negative surface charge, and therefore prolong DNA survival (ref).
...
![Taphonomic processes affecting sedimentary DNA signals from terrestrial, water and sedimentary environments (Giguet--Covex et al., 2023)](assets/images/chapters/introduction-to-edna/figure4.jpg){#fig-introductiontoedna-figure4}

### Mineralogical influence on preservation

Different minerals have varying adsorption capacities, yet research has demonstrated that specific clays appear to be the most effective at preserving eDNA.
For example, clay minerals such as Montmorillonite can absorb more than their own weight in DNA, because of their relatively large negatively charged surface area (ref).
Compared with clays, sand has been found less effective in binding DNA, but adsorption to sand is possible and increases with divalent cation concentrations (Ca2+ and Mg2+ (ref).
We can use this information to target layers in sediment records that have high clay content as hotspots for ancient eDNA (Kanbar et al., 2020).


How do they work? Let's take smectite clay as an example (@fig-introductiontoedna-figure5).
Smectite belongs to the 2:1 clay type, characterised by two tetrahedral layers surrounding an octahedral layer.
...
These nucleases can themselves adsorb to sand and clay, potentially inhibiting their ability to hydrolyse extracellular DNA (ref).
...
Once the sediment sample has been collected, the first laboratory processing step involves DNA extraction (@fig-introductiontoedna-figure6).
...
Some methods may fail to recover all (or most) DNA molecules from a sediment sample, affecting the accuracy of the reconstruction of the genetic record (Capo et al., 2021).

A wide range of methods have been used in sedimentary DNA research, ranging from commercial kits (e.g., Powersoil® and PowerMax® from Qiagen) to custom protocols optimised for recovering short DNA fragments, a characteristic feature of ancient DNA.
Studies comparing different extraction methods have emphasised the importance of selecting methods optimised for different sediment types and taxonomic targets.

After extracting eDNA, various analytical methods have been used to analyse the DNA.
...
![Sedimentary DNA workflow suggested by Picardis et al., 2024.](assets/images/chapters/introduction-to-edna/figure6.jpg){#fig-introductiontoedna-figure6}
...
Contamination control measures begin at the sample collection stage.
...
![Sample collection following aDNA sterility protocols. Left: Field sampling, Rawlence et al., 2014. Journal of Quaternary Science. Right: Laboratory sub-sampling: Crump et al., 2022 Nature.](assets/images/chapters/introduction-to-edna/figure7.jpg){#fig-introductiontoedna-figure7}
...
After applying the tracer, the core surface is removed, and the sample is collected (Epp et al., 2019).
The presence of the tracer DNA on both the removed surface and the collected samples is then verified using PCR or qPCR (Bang-Andreasen et al., 2017).
...
Bang-Andreasen et al., 2017.](assets/images/chapters/introduction-to-edna/figure8.jpg){#fig-introductiontoedna-figure8}
...
If these databases are not thorough and carefully managed, you might not be able to identify all the species in your samples.
...
So, to generate reliable species lists from sediment DNA data, you need both a solid reference database and a well-designed analysis pipeline.

A good example of this is a widely reported metagenomic study of the New York subway, which suggested that the pathogens *Yersinia pestis* and *Bacillus anthracis* were part of the "normal subway microbiome" (Afshinnekoo et al., 2015).
However, reanalysis of the New York subway data with appropriate methods did not detect the pathogens (Ackelsberg et al., 2015).
...
![Microstratigraphic distribution of mitochondrial DNA of ancient mammalian taxa in impregnated sediment. Massilani et al., 2021, PNAS.](assets/images/chapters/introduction-to-edna/figure9.jpg){#fig-introductiontoedna-figure9}{#fig-introductiontoedna-figure9}
...
To investigate this issue, Haile and colleagues (2007) extracted aDNA from sediments dating back up to 3300 years at two cave sites in New Zealand's North Island (@fig-introductiontoedna-figure10).
These sites provided a unique opportunity to assess the presence or absence of DNA from non-indigenous fauna, like sheep, in sediments deposited before European settlement, serving as an indicator of DNA migration.
Their findings revealed that sheep DNA was present in strata containing moa DNA, suggesting genetic material had migrated downwards within the sediment (@fig-introductiontoedna-figure10).
...
Downward infiltration of water can transport DNA through the porous, granular sediments of caves and potentially soil profiles (Haile et al., 2007; Jenkins et al., 2012).
However, other studies indicate that this phenomenon is less likely in lake sediments or permanently frozen sediments.
Once lake sediments are compacted, vertical pore water movement is minimal, leading to the immobilization of multivalent metals and organic compounds in the sediment matrix (Anderson-Carpenter et al., 2011).

![Stratigraphic sections in two cave sites in the North Island of New Zealand. The amount of moa and sheep DNA is shown in the figure across the sediment records. Haile et al., 2007.](assets/images/chapters/introduction-to-edna/figure10.png){#fig-introductiontoedna-figure10}
...
A good example of this type of this application is the study published by Kjær and colleagues (2022).
...
The presence of certain marine species suggests a warmer climate compared to the present.
This use of ancient eDNA and traditional palaeoecological proxies (e.g., pollen) opened up new avenues for tracing the ecology and evolution of biological communities dating back _two million years_ (a new record in the aDNA field!).
...
However, prokaryotes have been overlooked in long-term ancient eDNA studies due to the difficulty in determining whether their DNA signals originate from sediment-living organisms or from dead microorganisms deposited over time (Vuillemin et al., 2023).
Recent advances in molecular genetic methods have enabled the identification of past microbial communities, including prokaryotes, and the tracing of their evolution and adaptation to environmental changes (Capo et al., 2021).
...
For example, a study by Buchwald and colleagues (2024) focused on the subarctic western Bering Sea, analysing metagenomic shotgun and diatom _rbcL_ amplicon sequencing data over glacial--interglacial cycles, including the Eemian interglacial period.
...
On the other hand, Armbrecht and colleagues (2022) examined a sedimentary DNA record spanning ~1 million years from the Scotia Sea in Antarctica to understand changes in phytoplankton communities over time.
...
The changes in the plant community reconstructed using sedimentary DNA matched perfectly with those described in previous studies using other palaeoecological proxies such as pollen, DNA metabarcoding, and hybridization capture (Schulte et al., 2021), further validating their observations.
