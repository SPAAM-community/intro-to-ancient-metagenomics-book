...
In this section, we will introduce basic concepts and definitions about phylogenetics and phylogenetic trees, the type of knowledge that can be drawn from those, and some considerations about the inclusion of ancient genomic data in phylogenetic analyses.
We will then perform a phylogenetic analysis of _Yersinia pestis_ genomes using several inference methods, including Neighbourgh-Joining, Maximum Likelihood and Bayesian inference.
