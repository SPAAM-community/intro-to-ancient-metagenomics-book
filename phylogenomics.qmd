...
Ancient genomes are powerful date for phylogenetic inference for several reason.
The most obvious one is that it might allow sampling lineages that have gone extinct in the past, thereby uncovering entire parts of the evolutionary history that are invisible from modern data alone.
