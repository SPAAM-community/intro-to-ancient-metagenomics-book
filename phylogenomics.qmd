...
Phylogenetic trees are composed of __branches__ (or edges) representing continuous lines of descent (or lineages), __nodes__  representing the split of an ancestral lineage into descending lineages, and tips (or leaves) representing the sampled entities.
...
An important component of phylogenetic models is the genetic substitution model.
...
We start by exploring the alignment in _MEGA_.
...
![Phylogenetic probabilistic model.](assets/images/chapters/phylogenomics/20.png){#fig-phylogenomics-20}
:::
...
We will estimate a time-tree from our alignment using Bayesian inference as implemented in the _BEAST2_ software.
...
We can assess the MCMC sampling using the program _Tracer_.
...
One of the most popular is the maximum clade credibility (MCC) tree, which works as follows:
...
A classic way to assess the temporal signal of a dataset is the root-to-tip regression.
