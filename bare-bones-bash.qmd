...
![An example command prompt](assets/images/chapters/bare-bones-bash/Command_line_screenshot.png){width=100%}
...
![This program takes no input, and prints one line to the stdout and one line to the stderr.](assets/images/chapters/bare-bones-bash/Datastream_showcase.png){width=100%}
...
![Here you can see an example of redirecting the output of the `datastreams_demo.sh` program from before. Redirecting the stdout with `>` only prints the stderr to the screen, and saves the stdout into `output.txt`. Additionally, we can redirect the stderr with `2>` into `runtime.log`, and then nothing is printed onto the screen.](assets/images/chapters/bare-bones-bash/Redirects_showcase.png){width=100%}
...
<!-- This is formatted differently since it is not a runnable command, and hence users don't need to copy paste it -->
...
<p align="center"> ![](assets/images/chapters/bare-bones-bash/How_to_cat.png){width=45%} ![](assets/images/chapters/bare-bones-bash/How_to_cat_bash.png){width=45%}</p>
