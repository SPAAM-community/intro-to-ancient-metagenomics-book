...
You see a friendly-looking metalhead (@fig-bbb_james), and decide to ask them for directions!
...
Lucky for you, a friendly looking local is passing by (@fig-bbb_aida)!
...
to your terminal to let you know when something is not going according to plan (@fig-Datastream_showcase)!
...
![Diagram showing stdin going into the program, and two output streams from the program: stderr and stdout, with the stdout being attached to the stdin of a second program](assets/images/chapters/bare-bones-bash/Piping.png){#fig-Piping width=80% fig-align="center"}
...
You don't always have to google for documentation! Many programs come with in-built help text,
...
You can assign variables (tell the computer what do you want it to contain)
...
you need to **repeat** a command multiple times on a list of things, for example
a list of files? 
...
One of the most important skills you develop when coding and/or using the
command line is __how to phrase your questions__ so you can get relevant
answers out of your search engine. 
...
![How to cat the wrong way (i.e., don't include the language in your Google search and get loads of cat pictures)](assets/images/chapters/bare-bones-bash/How_to_cat.png){#fig-how-to-cat width=45%}

![How to cat the BASH way (i.e., include the the language in your Google search and you get lots of terminal pictures! Much better, right? ...right?)](assets/images/chapters/bare-bones-bash/How_to_cat_bash.png){#fig-how-to-cat-bash width=45%}
:::
...
also ensures you can stay lazy, since <kbd>tab</kbd> completion will not keep finding
