...
<p align="center"> ![Aida](assets/images/chapters/bare-bones-bash/bbb_aida.png){#fig-barebonesbash-aida-intro width=15%}  ![James](assets/images/chapters/bare-bones-bash/bbb_james.png){#fig-barebonesbash-james-intro width=15%}  ![Thiseas](assets/images/chapters/bare-bones-bash/bbb_thiseas.png){#fig-barebonesbash-thiseas-intro width=15%}</p>


![Cartoony pictures of the three authors of the BareBonesBash course. Designed by Zandra Fagernäs.](https://i.creativecommons.org/l/by-sa/4.0/88x31.png){#fig-barebonesbash-license fig-align="center"}
...
interface of a computer or server (@fig-barebonesbash-command_line_screenshot).
...
![A friendly-looking metalhead.](assets/images/chapters/bare-bones-bash/bbb_james.png){#fig-barebonesbash-james width=20% fig-align="center"}
...
![A friendly-looking local.](assets/images/chapters/bare-bones-bash/bbb_aida.png){#fig-barebonesbash-aida width=20% fig-align="center"}
...
This gets printed
to our terminal to let us know when something is not going according to plan (@fig-barebonesbash-datastream_showcase)!
