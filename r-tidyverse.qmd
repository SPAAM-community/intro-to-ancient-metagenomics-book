...
- The tidyverse is a collection of R packages with well-designed and consistent interfaces for the main steps of data analysis: loading, transforming and plotting data (<https://www.tidyverse.org>)
  - This tutorial works with tidyverse ~v1.3.0
...
### Preparing the setup for this tutorial
...
- If you're reading this later and want to tinker with the example code, then you will need the following steps first:
...
# preparing data (at the end of this tutorial,
...
peng_prepped %>%
  ...
  readr::write_csv("penguin_bills_2009.csv")
```
...
- Here we rotate the x-axis labels by 45°
