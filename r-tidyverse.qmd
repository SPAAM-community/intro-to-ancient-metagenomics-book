...
::: {.callout-note title="SPAAM Summerschool 2024 setup" collapse="true"}
...
::: {.callout-note title="Home setup" collapse=true}

If you wish to follow this chapter on your personal computer please prepare your working environment with the following steps:
...
2. Open RStudio and create a new project with `File` -> `New Project...`.
3. Run the code below in the R console to install the necessary R package dependencies and prepare the required data.
...
# preparing data (at the end of this tutorial you will understand this code)
library(magrittr)
set.seed(5678)
...
4. Create a new R script file so that you can copy the relevant code sections into it and run them subsequently.
