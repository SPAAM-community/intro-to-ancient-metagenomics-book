...
```{r, echo=FALSE}
# Set global options
knitr::opts_chunk$set(attr.output = "style='border: 1px; border-style: solid;'")
```
...
- This is an important operation when discrete variables with a large set of values are mapped to one of the axes. The axis labels can otherwise overlap
