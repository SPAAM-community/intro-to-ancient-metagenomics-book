...
This looks neat for many sites, but some have too few samples.

**20**: As a final exercise remove these "single-dot" sites and recreate this plot. There are many possible ways to do this. The easiest may be to filter by the standard deviation (sd) along the age or the depth axis.
