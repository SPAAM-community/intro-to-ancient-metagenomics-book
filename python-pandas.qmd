...
::: {.callout-note collapse="true" title="**Note If the notebook is not there**"}
...
```
::: {.callout-note collapse="true" title="**Running bash code in Jupyter**"}
...
::: {.callout-note collapse="true" title="**why import as pd**"}
...
::: {.callout-note collapse="true" title="**More details on pandas**"}
