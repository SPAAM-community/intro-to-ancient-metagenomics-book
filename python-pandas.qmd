...
The function in `Pandas` that does just this is called `.concat`, This command combines two `DataFrames` by appending all rows. `.concat([first_dataframe, second_dataframe])`.
