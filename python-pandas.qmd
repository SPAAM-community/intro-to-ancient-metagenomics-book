...
::: {.callout-tip collapse="true" title="**why import as pd**"}
...
Pandas by default assume that the file is comma delimited, but we can change this by using the `sep= ` argument.
...
It is often useful to have a quick look at the first rows, to get, for example an idea of the data was read incorrectly. 
