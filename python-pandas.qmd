...
author: Kevin Nota (2023-2024), Robin Warner (2023), and Maxime Borry (2022)
---
...
popular libraries for data analysis `pandas` ([(https://pandas.pydata.org/](https://pandas.pydata.org/)).
...
It is of course also possible to copy the code from this chapter into a fresh notebook file by clicking on:
 `File` > `New` > `Notebook`.
...
Make sure that `pwd` returns `/vol/volume/python-pandas/python-pandas_lecture`.
:::
...
Pandas can read in _csv_ (comma separated values) files, which are tables in text format.It is called _c_sv because each value is separated from the others through a comma.
...
```{r}
#| label: tbl-pythonpandas-alldatahead
#| echo: false
#| results: 'asis'
#| tbl-cap: "reading in all_data.tsv."
...
## Expand to see output
```{r}
#| label: tbl-pythonpandas-plothead
#| echo: false
#| results: 'asis'
#| tbl-cap: "head all_data.tsv."
#| tbl-cap-location: top
#| message: false
#| warning: false
...
```{r}
#| label: tbl-pythonpandas-2rows
#| echo: false
#| results: 'asis'
#| tbl-cap: "first 2 rows all_data.tsv."
#| tbl-cap-location: top
#| message: false
#| warning: false
...
```{r}
#| label: tbl-pythonpandas-conditionalsubset
#| echo: false
#| results: 'asis'
#| tbl-cap: "conditional subset all_data.tsv."
#| tbl-cap-location: top
#| message: false
#| warning: false
...
## Expand to see output
```{r}
#| label: tbl-pythonpandas-conditionalsubset2
#| echo: false
#| results: 'asis'
#| tbl-cap: "conditional subset 2 all_data.tsv."
#| tbl-cap-location: top
#| message: false
#| warning: false
...
## Expand to see output
```{r}
#| label: tbl-pythonpandas-Describing
#| echo: false
#| results: 'asis'
#| tbl-cap: "Describing all_data.tsv."
#| tbl-cap-location: top
#| message: false
#| warning: false
...
```{r}
#| label: tbl-pythonpandas-isna
#| echo: false
#| results: 'asis'
#| tbl-cap: "is.na(all_data.tsv)."
#| tbl-cap-location: top
#| message: false
#| warning: false
...
## Expand to see output
```{r}
#| label: tbl-pythonpandas-concat
#| echo: false
#| results: 'asis'
#| tbl-cap: "concat all_data.tsv."
#| tbl-cap-location: top
#| message: false
#| warning: false
...
## Expand to see output
```{r}
#| label: tbl-pythonpandas-drop
#| echo: false
#| results: 'asis'
#| tbl-cap: "drop all_data.tsv."
#| tbl-cap-location: top
#| message: false
#| warning: false
...
```{r}
#| label: tbl-pythonpandas-merge
#| echo: false
#| results: 'asis'
#| tbl-cap: "merge all_data.tsv."
#| tbl-cap-location: top
#| message: false
#| warning: false
...
![This is the histogram of income that should appear with you run the code above.](https://github.com/Kevinnota/teaching_stuff/blob/main/histogram.png?raw=true){#fig-pythonpandas-incomehistogram}
:::
...
Now that you are familiar with python, pandas, and plotting.
...
Once completed, the command below will remove the `/<PATH>/<TO>/python-pandas` directory _as well as all of its contents_.
...
<!-- NO REFERENCES SO NOT NECESSARY
## References
-->