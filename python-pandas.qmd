...
- `![](https://www.spaam-community.org/assets/media/SPAAM-Logo-Full-Colour_ShortName.svg)` ![](assets/images/chapters/python-pandas/SPAAM-Logo-Full-Colour_ShortName.svg)
...
Another useful transformation is from a dictionary ([https://docs.python.org/3/tutorial/datastructures.html#dictionaries](https://docs.python.org/3/tutorial/datastructures.html#dictionaries)) to pd.Dataframe.
...
The output should generate a table like below.
:::
::: {.callout-note collapse="true" title="Answer"}
```{.python eval=False}  
...
As a hint, the fix should look like the table below.
:::
...
![This is the histogram of income that should appear with we run the code above.](assets/images/chapters/python-pandas/histogram.png){#fig-pythonpandas-incomehistogram}
:::
...
![To "fix" the histogram, the one person with the income of 666666 is removed, making the plot look a lot neater.](assets/images/chapters/python-pandas/fixed_histogram.png){#fig-pythonpandas-incomefixhistogram}
:::
...
![Barplot of the mean income for each education level.](assets/images/chapters/python-pandas/bar_plot.png){#fig-pythonpandas-barplot}
:::
### Scatter plot
...
![A scatter plot with wine purchases on the x-axis and fruit purchases on the y-axis.](assets/images/chapters/python-pandas/scatter_polt_01.png){#fig-pythonpandas-scatterplot}
:::
...
![The scatter plot with wine purchases on the x-axis and fruit purchases on the y-axis, with on a log scale.](assets/images/chapters/python-pandas/scatter_polt_02.png)
:::
...
![Boxplot with the amount spent on wine per education.](assets/images/chapters/python-pandas/boxplot.png){#fig-pythonpandas-boxplot}
:::
...
![Plot of the income of people born after 1900, faceted by marital status, and filled by education level.](assets/images/chapters/python-pandas/facet_scatter.png){#fig-pythonpandas-facetplot}
:::
