...
This chapter introduces the field of environmental DNA (eDNA), with a particular focus on ancient environmental DNA preserved in sediments (sedimentary ancient DNA or sedaDNA).
We begin by defining what is environmental DNA and discussing its inherent complexity, especially when working with ancient eDNA. 

Next, we untangle this complexity by exploring the different components found in sedimentary DNA records.
We then examine the processes that influence how these records are formed and preserved (i.e., taphonomic processes), emphasising their importance for the reliability of sedimentary DNA data.
We also address some limitations of this method and offer key considerations for overcoming them. 
