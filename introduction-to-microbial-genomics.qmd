...
Usually specialized organisms with delimited ecological niches.
...
For example, if the organism of interest enters the bloodstream, teeth, which are vascularized and are excellent DNA archives, will probably be a good choice for sampling.
Some pathogens (e.g.
...
Viruses are less affected, as they do not carry house-keeping genes, and only have a very small usually highly specialized set of genes, which makes them easier to validate.
...
Particularly with clonal species (e.g.
Black Death genomes).
:::
...
However, some increase their virulence by reducing their genome and becoming highly specialized (e.g.
...
This is often the case in highly specialized organisms.
...
Important exception are known and heavily conserved mutations, which for example are involved in **pseudogenization**.
Pseudogenization is the process through which genes lose their function due to mutations but remain in the genome without being expressed or without having a function.
