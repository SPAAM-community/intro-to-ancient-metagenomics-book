...
::: {.callout-note collapse="true" title="Answer"}
Whether ancient, non westernized, or westernized gut microbiome sample, the phylum Firmicutes (officially renamed Bacillota since 2021) is the most abundant.
:::
...
We worked on relative abundances provided by metaphlan. But beware that not all taxonomic profilers will output relative abundances. To perform quantitative analysis of taxonomic profiles, sequencind data need to be normalized for sequencing depth. There are many different ways to normalize sequencing data, but this out of the scope of this session. Just to name a few, the most commonly used are RLE, TSS, rarefaction, CLR, or GMPR.
:::
