...
```bash
wget -q -O taxonomic-profiling.tar.gz -P /<PATH>/<TO>/<SOMEWHERE_TO_STORE>/ https://www.dropbox.com/scl/fi/pljjweplz534ut9gyl87m/taxonomic-profiling.tar.gz?rlkey=owmeonoupcattbwsy5til4d9i&dl=0
