...
::: {.callout-tip}
For this chapter's exercises, if not already performed, you will need to create the [conda environment](before-you-start.qmd#creating-a-conda-environment) from the `yml` file in the following [archive](https://doi.org/10.5281/zenodo.6983148), and activate the environment:
...
![figures/geom_cheatsheet.png](assets/images/chapters/introduction-to-r/geom_cheatsheet.png)(){width=55%}
...
![](assets/images/chapters/introduction-to-r/pivot_longer_wider.png)
...
![](assets/images/chapters/introduction-to-r/left_join.png)
...
![](assets/images/chapters/introduction-to-r/right_join.png)
...
![](assets/images/chapters/introduction-to-r/inner_join.png)
...
![](assets/images/chapters/introduction-to-r/full_join.png)
...
![](assets/images/chapters/introduction-to-r/semi_join.png)
...
![](assets/images/chapters/introduction-to-r/anti_join.png)
