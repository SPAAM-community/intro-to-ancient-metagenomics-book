...
```bash
wget --quiet -O genome-mapping.tar.gz https://www.dropbox.com/scl/fi/wghlf22dxyl4imp96wf9x/genome-mapping.tar.gz?rlkey=mw90slu9ep9tdzpypfxrsrfuj&dl=0 -P /<PATH>/<TO>/<SOMEWHERE_TO_STORE>/
tar -xzf genome-mapping.tar.gz
cd genome-mapping
```
:::
