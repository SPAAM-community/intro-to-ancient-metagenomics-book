...
```bash
wget -O denovo-assembly.tar.gz https://www.dropbox.com/scl/fi/a2ax5retqrhci51gg8nzq/denovo-assembly.tar.gz?rlkey=8j8u18g710omadudhcwz61072&dl=0 -P /<PATH>/<TO>/<SOMEWHERE_TO_STORE>/ 
tar -xzf denovo-assembly.tar.gz
cd denovo-assembly
```
:::
...
::: {.callout-warning}
If you plan to run through the [ancient metagenomic pipelines](ancient-metagenomic-pipelines.qmd) chapter, do not clear up the denovo assembly directory yet! The data from this chapter will be re-used.
:::
