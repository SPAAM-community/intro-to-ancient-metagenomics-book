...
If you have sufficient computational memory resources, you can run the steps in the collapsed 'Example commands' section belowto run the bin refinement yourself.
:::
...
An alternative for users with a less powerful infrastructure is the program [KrakenUniq](https://github.com/fbreitwieser/krakenuniq), however if your infrastructure has sufficient computational resources, or you want to see how you would run `mmseqs2` see the collapsed 'Example commands' block below.
:::
...
If you want to see how you would run the `gtdbtk classify_wf` see the collapsed 'Example commands' block below.
:::
