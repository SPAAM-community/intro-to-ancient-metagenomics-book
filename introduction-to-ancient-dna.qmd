...
Briggs and colleagues also described a second damage-related pattern present in the Vindija Neanderthal DNA sequences: an excess of errors or differences from the reference at the ends of each DNA sequence (@fig-introductiontoancientdna-14XXXX). 
...
![Damage plot of DNA from the Vindija Neanderthal. An elevated substitution frequency of C->T at the 5’ end of the DNA molecules is consistent with accelerated cytosine deamination in the single stranded overhangs at the ends of ancient DNA molecules. Note that due to repair steps during NGS library construction, the 3’ G->A substitutions are simply the reverse complement of the 5’ C->T substitutions. Figure adapted from [@Briggs2007-ch].](assets/images/chapters/introduction-to-ancient-dna/fig-introductiontoancientdna-14XXX.png){#fig-introductiontoancientdna-14XXXX}
