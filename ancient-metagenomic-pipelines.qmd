...
**Makefiles**, [https://en.wikipedia.org/wiki/Make_(software)](https://en.wikipedia.org/wiki/Make_(software)))) to very powerful and abstract (e.g.
**Workflow Description Language**, [https://github.com/openwdl/wdl](https://github.com/openwdl/wdl)).
In this chapter we will use pipelines that use two popular workflow managers in bioinformatics, **Nextflow** ([https://nextflow.io](https://nextflow.io)) and **Snakemake** ([https://snakemake.github.io](https://snakemake.github.io)).
...
Finally, nf-core eager uses MultiQC ([https://multiqc.info/](https://multiqc.info/)) to create an integrated html report that summarises the output/results from each of the pipeline steps.
...
Check here ([https://tower.nf](https://tower.nf) for more information.
...
Detailed documnetation can be see on the nf-core/mag parameters ([https://nf-co.re/mag/2.3.2/parameters](https://nf-co.re/mag/2.3.2/parameters)) and output ([https://nf-co.re/mag/2.3.2/docs/output](https://nf-co.re/mag/2.3.2/docs/output) pages.
...
6 . Skip a few steps that are either 'nice to have' (e.g.
