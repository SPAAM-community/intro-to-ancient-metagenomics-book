...
time nextflow run nf-core/mag -r 2.3.2 -profile test,docker --input '*{R1,R2}.fastq.gz' --outdir ./results --skip_spades --skip_spadeshybrid --skip_prodigal --binning_map_mode own --skip_maxbin2 --skip_concoct --binqc_tool checkm --checkm_db db/checkm_data_2015_01_16/ --ancient_dna --gtdb false --centrifuge_db false --kraken2_db false --skip_krona -resume -c custom.config  --busco_reference false --keep_phix
