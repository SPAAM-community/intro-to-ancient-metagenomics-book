...
4. Activate the various of the steps of the pipeline we're interested in
    ...
    - we turn on genotyping using GATK UnifiedGenotyper (preferred over HaplotypeCaller [@Poplin2018-yq] due to in compatibility with that method to low-coverage data)
