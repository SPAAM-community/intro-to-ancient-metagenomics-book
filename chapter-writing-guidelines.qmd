...
- Full stops should come after closing parentheses. 
    - For example, in this sentence (the full stop comes after the closing parenthesis).
...
:::{.callout-warning}
On-the-fly code-generated tables should not be placed in call out boxes!
This prevents generation of PDF versions of the page with a `LaTeX Error: Not in outer par mode.` error.
:::
